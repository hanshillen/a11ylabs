...
let $ = function (selector: string, node: Element | HTMLDocument = document){
...
class Spinner {
    ...
    constructor (min: number, max: number, step: number, value: number = 1, labelText: string, options: Object = {}) {
        ...
        this.input = $(`#${this.id}`, this.el) as HTMLInputElement;
        this.decBtn = $(`.decBtn`, this.el) as HTMLButtonElement; 
        this.incBtn = $(`.incBtn`, this.el) as HTMLButtonElement;
